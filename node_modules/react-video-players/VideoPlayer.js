...
var _VideoEmbed = require('./embeds/VideoEmbed');
...
var VideoPlayer = function (_Component) {
  ...
  VideoPlayer.prototype.render = function render() {
    ...
    return _react2.default.createElement(_VideoEmbed2.default, _extends({}, this.props, { style: style }));
  };
...
exports.default = (0, _playerController2.default)(VideoPlayer);